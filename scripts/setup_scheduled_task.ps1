...
# every trading day (Mon-Fri) at 17:00.
# Why 17:00: ezmoney.com.tw (Uni-President) usually publishes its PCF list after 16:30;
# the other three issuers publish between 14:45-16:30, so 17:00 covers all four.
#
# Usage (PowerShell):
...
Write-Host "Scheduled task '$taskName' created: runs Mon-Fri at 17:00."
